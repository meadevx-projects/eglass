...
if(isset($_GET['docr_id']))
{
	$docr_id=$_GET['docr_id'];
	
	$docrTasksEachQry="SELECT * FROM docr_tasks WHERE docr_id='".$docr_id."'";
	$docrTasksEachRes=$dbObj->fireQuery($docrTasksEachQry);
}
                    ...
                    <div class="col-lg-12">
                            ...
                            <tbody>
                               <tr>
                                ...
                                <td><?php echo htmlentities($docrTasksEachRes[0]['docr_imgfile']); ?></td>
                               </tr>
                               <tr>
                                <td><strong>Image:</strong></td>
                                <td><table  border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td><img src="<?php echo $SITE_URL."uploads/".htmlentities($docrTasksEachRes[0]['docr_imgfile']); ?>" alt="<?php echo htmlentities($docrTasksEachRes[0]['docr_imgfile']); ?>"/></td>       
                                    </tr>
                                </table>
                                </td>
                               </tr>
                               <tr>
                                ...
                                <td><?php echo htmlentities($docrTasksEachRes[0]['docr_ocrtext']); ?></td>
                               </tr>
                               <tr>
                                 <td colspan="2">&nbsp;</td>
                               </tr>
